...
import SmileSelfie from "@/components/ui/icons/SmileSelfie";
...
export default function Home() {
  ...
  const { setRenaper, foto, renaper } = useApoderadoContext();
    ...
    <>
      <div className="mx-auto h-72 text-center relative w-[350px] 2xl:left-40 2xl:max-w-[90%]">
        ...
        <p className="text-gray-400 mt-2 text-sm">
          {intentos === 0 && !selectedFile
            ? "Sacate una selfie sonriendo y subila."
            : intentos === 1 && !selectedFile
        ...
        {intentos === 0 && !selectedFile ? (
          <div className="w-[350px] text-center text-sm relative top-8">
            <p>
              <span className="text-base">•</span> Usá un fondo liso para tomar
              la foto
            </p>
            <p>
              <span className="text-base">•</span> No uses anteojos, gorros y
              cualquier objeto que tape tu cara
            </p>
          </div>
        ) : null}
          ...
          <div className="flex w-[400px] h-28 justify-center  relative ">
            ...
            {intentos >= 2 && !selectedFile && (
              <button
                ...
                className="bg-primary-500 text-xs py-2  px-6 rounded-lg text-white h-10 max-w-[240px] relative top-2  mb-4" // Añadido margen inferior
              >
